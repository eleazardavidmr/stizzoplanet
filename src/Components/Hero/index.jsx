...
export function Hero() {
  return (
    <>
      <motion.section
        className="w-screen mt-10 h-max-screen lg:-mt-7 lg:h-[100vh] mb-6 text-center mx-auto flex-col gap-10 flex items-center justify-center md:flex-row md:justify-between md:w-[80vw] md:text-left"
        role="banner"
      ...
      >
        <motion.span className="flex flex-col w-full text-3xl font-semibold text-white">
          ...
          <button
            className="hero-button py-2.5 px-5 text-sm font-bold mt-3 bg-secondary hidden md:flex w-fit"
            aria-label="Explorar productos en Instagram"
          >
            <a
        ...
        <motion.img
          src={logo}
          alt="Logo de Stizzo Planet con efecto de sombra"
