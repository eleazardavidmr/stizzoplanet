      ...
      <AnimatePresence initial={false}>
        {context.isOrderCheckOpen && (
          <motion.aside
            ...
            animate={{ x: 0 }}
            exit={{ x: "-100vw" }}
            className="fixed w-[80vh] top-0 h-[100vh] md:w-[40vw] overflow-y-auto lg:w-[30vw] flex flex-col order-check z-[999] "
          >
            ...
            {context.cartProducts.length > 0 ? (
              <figure className="w-full mx-auto flex flex-col justify-between gap-y-5 md:w-full ">
                <AnimatePresence initial={false}>
                  {context.cartProducts.map((product, index) => {
                    return (
                      <motion.div
                        ...
                        exit={{ x: -1000 }}
                        key={index}
                        className="flex w-[90%] mx-auto rounded-lg p-0 border border-gray-300 dark:border-gray-700"
                      >
                        <img
                          src={product.img}
                          alt={product.title}
                  ...
                  <div className="sticky bottom-0 w-full flex items-center justify-center bg-slate-900 p-5">
                    <div className="w-[80%] flex items-center justify-between">
                      <p>Tienes {context.count} productos en el carrito </p>
                      <a
